...
public class TestList {
  ...
  public void testRemoveObject() {
    ...
    // This method removes the 6th number (counting from 1 to end) of the list meaning INDEX 5
    // TODO fix the expected values in the assertions below
    ...
    //This method removes any value node/container in the list that has a value of 5.
